...
for table in table_data:
    ...
    if ( table_id ):
        ...
        if ( "DataList1_DataGrid1" in table_id ):
            ...
            roster_obj['students'] = sorted(roster_obj['students'], key=lambda k: (k['lastName'], k['firstName']));
...
fullListOfStudents = sorted(fullListOfStudents, key=lambda k: (k['lastName'], k['firstName']));
examId = 1
